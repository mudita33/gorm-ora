...
import (
	"database/sql"
	"fmt"
	"github.com/mudita33/gorm-ora/clauses"
...
func (d Dialector) DataTypeOf(field *schema.Field) string {
	...
	addAutoIncrementWhenAvailable := func() {
		if field.AutoIncrement {
			//replace if you want default cache 20
			//sqlType += " GENERATED BY DEFAULT AS IDENTITY"
			sqlType += " GENERATED BY DEFAULT AS IDENTITY INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 NOCYCLE NOCACHE NOORDER"
		}
	}
